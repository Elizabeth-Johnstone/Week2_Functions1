...
// let nameGreeting = nameCheck('Marissa')
...
// let colorRating = faveColorFinder('apple')
...
/*
  ...
  Outside the function, create a variable called `oddChecker` and
  set it equal to your function invoked, making sure to pass in an argument.
*/
...
/*
  ...
  If it does, return 'email verified' and if it doesn't, 
...
//   }
// }
// console.log(emailCheck('hello@gmail.com '))
...
// function chocolateFrogPurchase(goldToSpend) {
//   return goldToSpend / 3
// }
// let totalFrogs = chocolateFrogPurchase(5)
...
/*
  ...
  (give it the same name, just add a 2 to the end of it)
  that fixes this bug. Invoke the function and store the returned value to a variable called `totalFrogs2`.
*/

// function chocolateFrogPurchase(goldToSpend) {
//   numberOfFrogs = goldToSpend / 3
//   return Math.floor(numberOfFrogs)
// }

// let totalFrogs2 = chocolateFrogPurchase(7)
// console.log(totalFrogs2)


////////////////// PROBLEM 15 ////////////////////
let sampleArray = [0,1,2,3,4,7,8,9]
/*
...
function ascendingCheck(arrayOfNums) {
  let comparisonValue = arrayOfNums[0]
  for (let i = 1; i < arrayOfNums.length - 1; i++) {
    if (comparisonValue >= arrayOfNums[i]) {
      return false
    } else {
      comparisonValue = arrayOfNums[i]
...
arrayIsAscending = ascendingCheck(sampleArray)
...
/*
  ...
  Given the functions and variables above, edit the arrays below to contain only
  the appropriate variable names (as strings).
*/
